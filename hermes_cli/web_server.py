...
from hermes_cli.web_routers import (  # noqa: E402
    ...
    honcho_bridge as _honcho_bridge_routes,
)
...
app.include_router(_honcho_bridge_routes.router)
app.include_router(_chat_ws_routes.router)
app.include_router(_dashboard_ui_routes.router)

# ---------------------------------------------------------------------------
# FORK: kyroskoh/hermes-agent — inline routes below (fallback chain, model
# orchestrator, personality knobs) predate the router-extraction refactor and
# still live directly on `app` here rather than in hermes_cli/web_routers/.
# Functionally fine (this module still owns `app`), but inconsistent with the
# new convention — a follow-up should extract these into their own
# hermes_cli/web_routers/fork_model_features.py router module.
# ---------------------------------------------------------------------------
