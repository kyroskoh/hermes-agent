...
class GatewayShutdownMixin:
    ...
    async def _notify_active_sessions_of_shutdown(self) -> None:
        ...
        for platform, adapter in list(self.adapters.items()):
            # Multi-home broadcast: an operator reachable on more than one chat (e.g. two WhatsApp
            # LIDs, or a Telegram home + a Discord admin thread) gets every configured home.
            # `get_home_channels()` already includes the singular `home_channel` for back-compat,
